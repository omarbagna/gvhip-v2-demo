						...
						<div className="team-member-list">
							<ul>
								<li data-aos="zoom-in" data-aos-duration="1200">
									<BlurImage src={teamImg1} alt="member-image" />
								</li>
								<li
									data-aos="fade-down"
									data-aos-duration="1200"
									data-aos-delay="100">
									<BlurImage src={teamImg2} alt="member-image" />
								</li>
								<li
									data-aos="fade-down"
									data-aos-duration="1200"
									data-aos-delay="200">
									<BlurImage src={teamImg3} alt="member-image" />
								</li>
								<li
									data-aos="fade-up"
									data-aos-duration="1200"
									data-aos-delay="300">
									<BlurImage src={teamImg4} alt="member-image" />
								</li>
								<li
									data-aos="fade-up"
									data-aos-duration="1200"
									data-aos-delay="400">
									<BlurImage src={teamImg5} alt="member-image" />
								</li>
								<li
									data-aos="fade-down"
									data-aos-duration="1200"
									data-aos-delay="500">
									<BlurImage src={teamImg6} alt="member-image" />
								</li>
							</ul>
							<BlurImage src={bgShape1} alt="bg-image" className="bg-image" />
						</div>
					</div>
				</div>
			</div>
